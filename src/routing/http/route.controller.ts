...
export class RouteController {
  ...
  @Get(':routeId/stops') @ApiResponse({ status: 200, type: RouteStopsResponseDto }) listStops(@Param('vendorId', ParseUUIDPipe) vendorId: string, @Param('routeId', ParseUUIDPipe) routeId: string, @Query() query: RouteStopsQueryDto) { return this.routes.listStops(requestContextStore.requireActor(), vendorId, routeId, query.serviceDate); }
  @Post(':routeId/stops') @HttpCode(200) @ApiResponse({ status: 200, type: RouteStopsResponseDto }) replaceStops(@Param('vendorId', ParseUUIDPipe) vendorId: string, @Param('routeId', ParseUUIDPipe) routeId: string, @Body() body: ReplaceRouteStopsRequestDto) { return this.routes.replaceStops(requestContextStore.requireActor(), vendorId, routeId, body); }
