...
import { CreateRouteRequestDto, RenameRouteRequestDto, RouteListResponseDto, RoutePageQueryDto, RouteResponseDto, RouteVersionReasonRequestDto, toRouteResponse } from './route.dto.js';
...
for (const [key, types] of [['list', [String, RoutePageQueryDto]], ['create', [String, CreateRouteRequestDto]], ['get', [String, String]], ['rename', [String, String, RenameRouteRequestDto]], ['deactivate', [String, String, RouteVersionReasonRequestDto]], ['reactivate', [String, String, RouteVersionReasonRequestDto]], ['softDelete', [String, String, RouteVersionReasonRequestDto]], ['restore', [String, String, RouteVersionReasonRequestDto]]] as const)
